...
<body>
	<div class="main-content">
		...
		<form id="listForm" action="/admin/board/list">
						...
						<c:forEach var="item" items="${list}">
							<tr>
								...
								<td class="al-left">
									...
									<a href="/admin/board/view?username=${param.username}&boardId=${param.boardId}&contentId=${item.contentId}">${item.title}</a>
		...
		<div class="btn-wrap">
			...
			<a href="/admin/main" class="btn right">전체 게시판 보기</a>
		</div>
	</div>
</body>